...
import { Locked, Undo,Unlocked, UploadPreview, Settings, ScrollSvg, CropArea, Rotate3dSvg } from '@/app/components/icons/SvgIcons';
				...
				<div className="step-area-inner">
					<div className="step-item" >						
							<div className="step-item-inner" 
								...
								{ currentStep !== 1 && (
									<div className='btn-preview-upload' onClick={() => { if (inputRef.current) inputRef.current.click()}} style={{display: 'flex', justifyContent: 'space-between', alignItems:'center'}}>
